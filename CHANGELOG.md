...
* The list-option `keywords_admin_only` has been removed. The functionality was replaced by the list-option `subscriber_permissions`, which is honoured by the API as well as the keyword handlers. (#374)
