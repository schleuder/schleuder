...
describe Schleuder::ListsController do
  describe '#lists' do
    it 'returns the lists that belong to the account' do
      ...
      lists = ListsController.new(account).lists
  ...
  describe '#new' do
    it 'returns a new list' do
      ...
      expect(ListsController.new(account).new).to be_an_instance_of List
    end
  end
  ...
  describe '#list' do
    it 'returns a list for a given list id' do
      ...
      expect(ListsController.new(account).list(list.id)).to eq list
    end
    ...
    it 'returns a list for a given list email address' do
      ...
      expect(ListsController.new(account).list(list.email)).to eq list
    end
    ...
    it 'raises an unauthorized error when the user is not authorized' do
      ...
      expect do
        ListsController.new(unauthorized_account).list(list.id)
      end.to raise_error(Schleuder::Errors::Unauthorized)
    end
  end
