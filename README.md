...
1. Download [the gem](https://schleuder.org/download/schleuder-4.0.1.gem) and [the OpenPGP-signature](https://schleuder.org/download/schleuder-4.0.1.gem.sig) and verify:
   ```
   gpg --recv-key 0xB3D190D5235C74E1907EACFE898F2C91E2E6E1F3
   gpg --verify schleuder-4.0.1.gem.sig
   ```

2. If all went well install the gem:
   ```
   gem install schleuder-4.0.1.gem
   ```
...
Alternatively to the gem-files you can download the latest release as [a tarball](https://schleuder.org/download/schleuder-4.0.1.tar.gz) and [its OpenPGP-signature](https://schleuder.org/download/schleuder-4.0.1.tar.gz.sig).
