...
1. Download [the gem](https://0xacab.org/schleuder/schleuder/raw/master/gems/schleuder-3.1.0.gem) and [the OpenPGP-signature](https://0xacab.org/schleuder/schleuder/raw/master/gems/schleuder-3.1.0.gem.sig) and verify:
   ```
   gpg --recv-key 0xB3D190D5235C74E1907EACFE898F2C91E2E6E1F3
   gpg --verify schleuder-3.1.0.gem.sig
   ```

2. If all went well install the gem:
   ```
   gem install schleuder-3.1.0.gem
   ```
...
Alternatively to the gem-files you can download the latest release as [a tarball](https://0xacab.org/schleuder/schleuder/raw/master/gems/schleuder-3.1.0.tar.gz) and [its OpenPGP-signature](https://0xacab.org/schleuder/schleuder/raw/master/gems/schleuder-3.1.0.tar.gz.sig).
