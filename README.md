...
Installation
------------
1. Download [the gem](https://schleuder.nadir.org/download/schleuder-3.0.0.beta4.gem) and [the OpenPGP-signature](https://schleuder.nadir.org/download/schleuder-3.0.0.beta4.gem.sig) and verify:
   ```
